...
contract VickreyAuction {
   ...
   // error TooLate(uint time);
            ...
            returns (bool success)
    {
        if (value <= Auctions[auction_id].secondHighestBid) {
        ...
        else if (value >= Auctions[auction_id].secondHighestBid && value <= Auctions[auction_id].highestBid) {
            if(Auctions[auction_id].secondHighestBidder != address(0)) {
                Auctions[auction_id].pendingReturns[Auctions[auction_id].secondHighestBidder] += Auctions[auction_id].secondHighestBid;
            ...
            Auctions[auction_id].secondHighestBidder = Auctions[auction_id].highestBidder;
        ...
        auctionActive(auction_id)
    {
        ...
        if(Auctions[auction_id].highestBidder == address(0) && Auctions[auction_id].highestBid == 0){
            emit ItemUnsold(auction_id);
            emit AuctionEnded(auction_id,address(0),0);
            Auctions[auction_id].ended = true;
        }
        else if(Auctions[auction_id].secondHighestBidder == address(0) && Auctions[auction_id].secondHighestBid == 0){
        ...
        {
            emit AuctionEnded(auction_id,Auctions[auction_id].secondHighestBidder, Auctions[auction_id].secondHighestBid);
            Auctions[auction_id].ended = true;
            Auctions[auction_id].sold = true;
            Auctions[auction_id].highestBidder.transfer(Auctions[auction_id].highestBid);
            //highest.transfer(Auctions[auction_id].highestBid);
            Auctions[auction_id].beneficiary.transfer(Auctions[auction_id].secondHighestBid);
            emit WinnerChosen(auction_id,Auctions[auction_id].secondHighestBidder);
