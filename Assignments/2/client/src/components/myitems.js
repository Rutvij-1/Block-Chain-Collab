...
class MarketPlace extends Component {
    ...
    componentDidMount = async () => {
        try {
          ...
          let offSet = 1000;
          let blindAuctions = await this.props.blind_contract.methods.getactiveauctions().call({ from: this.state.currentAccount });
            ...
            let vikreyAuctions = await this.props.vickrey_contract.methods.getactiveauctions().call({ from: this.state.currentAccount });
            ...
            let averageAuctions = await this.props.average_contract.methods.getactiveauctions().call({ from: this.state.currentAccount });
